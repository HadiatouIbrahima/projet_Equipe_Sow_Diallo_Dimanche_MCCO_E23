	...
	public Initialisation() throws org.json.simple.parser.ParseException, IllegalAccessException, InstantiationException, NoSuchMethodException, InvocationTargetException {
		...
		*/
		...
		this.statut = statut;
		 ...
		 JSONObject jsonEmpl3 = JsonJava.convertirObjetEnJson(alpha);
			...
			JSONArray jsonArrayEmpl = JsonJava.convertirListeEnJson(listeEmpl);  //liste json Employe unique pour tous
			 ...
			 Projet proj3 = new Projet ("P2", "projet3", "01-06-2023 00:00:01", "30-09-2023 23:59:59", 5000);
		...
		//Fonctionnalit� 1 : Rapport d'�tat de chaque projet
				...
				System.out.println("Heure travaille Projet 1"+ heureTravProj1+ "\n\n");
        ...
        System.out.print("Bienvenue sur TimeLog. Veuillez choisir votre statut:\n (1) si vous �tes Admin,\n(2) si vous �tes employ�");
        String votreStatut = scanner.nextLine();
        // Affiche le statut
        System.out.println("Votre statut est : " + votreStatut);
        
        // Demande � l'utilisateur de saisir une chaine de caracteres
        ...
        // Affiche la cha�ne de caract�res saisie par l'utilisateur
        System.out.println("Veuillez saisir votre mot de passe : " );
        String motDePasse = scanner.nextLine();
       
        //V�rifier infos connexion
        if(nomUtilisateur.equalsIgnoreCase(admin.getNomUtilisateur()) 
        	...
        	System.out.println("Votre connexion a r�ussi !");
        	admin.setEstConnecte(true);
        	System.out.println("Statut de connexion : "+ admin.isEstConnecte());
        }else {
        	System.out.println("Nous sommes desoles ! Informations fournies incorrectes" );
        	System.out.println("Statut de connexion : "+ admin.isEstConnecte());
        }
